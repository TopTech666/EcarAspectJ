package com.ecar.ecaraspectj.hugos;
...
public class Hugo {
    ...
    //带有DebugLog注解的所有类
    @Pointcut("within(@com.ecar.ecaraspectj.anotation.DebugLog *)")
    ...
    //在带有DebugLog注解的方法
    @Pointcut("execution(@com.ecar.ecaraspectj.anotation.DebugLog * *(..)) || methodInsideAnnotatedType()")
    public void method() {
    }

    //在带有DebugLog注解的构造方法
    @Pointcut("execution(@com.ecar.ecaraspectj.anotation.DebugLog *.new(..)) || constructorInsideAnnotatedType()")
